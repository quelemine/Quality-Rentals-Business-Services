          ...
          <div className="flex items-center justify-between h-16 sm:h-20">
            ...
            <div className="hidden lg:flex items-center space-x-6">
              ...
              <button
                ...
                className="bg-gold text-white px-4 py-2 rounded-full font-medium hover:bg-white hover:text-navy transition-colors text-sm"
              >
            ...
            <div className="hidden md:flex lg:hidden items-center space-x-4">
              ...
              <button
                onClick={() => setIsDrawerOpen(true)}
                className="bg-gold text-white px-3 py-2 rounded-full font-medium hover:bg-white hover:text-navy transition-colors text-xs"
              >
                Get a Quote {totalItems > 0 && <span className="ml-1 rounded-full bg-navy px-1.5 py-0.5 text-[10px]">{totalItems}</span>}
              </button>
            </div>
